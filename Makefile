DISTRIBUTOR_CONSOLE_VERSION=6.0.0-alpha.3
DISTRIBUTOR_VERSION=6.0.0-alpha.3
COMMON_VERSION=6.0.0-alpha.3
MESSAGES_VERSION=6.0.0-alpha.3
ADAPTERS_VERSION=6.0.0-alpha.3
JWT_AUTHENTICATION_VERSION=6.0.0-alpha.3
LDAP_AUTHENTICATION_VERSION=6.0.0-alpha.3
PWD_AUTHENTICATION_VERSION=6.0.0-alpha.3
MKPASSWD_VERSION=6.0.0-alpha.3
